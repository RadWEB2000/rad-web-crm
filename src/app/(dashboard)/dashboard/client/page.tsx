...
export default async function ClientPage() {
	...
	const psiData = {
		...
		preview: {
			...
			src: psi.desktop.lighthouseResult.audits['final-screenshot'].details
				.data,
		...
		<div className={styles.wrapper}>
			<div className={styles.details}>
				<Details
					...
					managment={{
						cooperation: {
							start: 'Tue Feb 21 2023 15:29:03 GMT+0100 (Central European Standard Time)',
			...
			<div className={styles.pagespeed}>
				<PageSpeedInsights
					...
					statistics={{
						desktop: {
							accessibility:
								psiData.desktop.accessibility.score * 100,
							performance:
								psiData.desktop.performance.score * 100,
							seo: psiData.desktop.seo.score * 100,
							practices:
								psiData.desktop['best-practices'].score * 100,
						},
						mobile: {
							accessibility:
								psiData.mobile.accessibility.score * 100,
							performance: psiData.mobile.performance.score * 100,
							seo: psiData.mobile.seo.score * 100,
							practices:
								psiData.mobile['best-practices'].score * 100,
						},
					}}
				/>
			</div>
